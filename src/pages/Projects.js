          ...
          {language ? (
            <div className="project-text">
              <p>
                ...
                empreendimento para adicionar imagens, promoções, parcerias,
              ...
              <p>
                ...
                breve das partes principais do projeto facilitando o
                entendimento desde o design até o código de todas as partes.
              </p>
              <p>
            ...
            <div className="project-text">
              <p>
                This project focuses on a vacation house with a CMS, allowing
                the administrator to fully manage images, promotions,
                partnerships, and social media, much like WordPress.{' '}
              </p>
              <p>
                Built entirely with Angular using a Mobile First approach, it
                also includes a desktop version. The homepage features a landing
                page layout, with a long vertical page where you can navigate
                through sections for house amenities, interiors, promotions, and
                customer reviews. Here’s a brief{' '}
                <a
                  href="https://docs.google.com/document/d/11DM5CFHE5VNcDCnbtJU0A14ib3OCgvuLlhsZemB-TQg/edit"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                overview of the main parts of the project, providing clarity
                from design to code for all sections.
              </p>
              <p>
